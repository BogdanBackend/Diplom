...
Для захоплення радіосигналу потрібні антени
...
![Рис 4.1. HackRF-One](/workspaces/Diplom/docs/word/imgs/image-1.png){ width=8.0cm }
...
![Рис 4.2. RTL-SDR v3](/workspaces/Diplom/docs/word/imgs/image-22.png){ width=8.0cm }
...
![Рис 4.3. LimeSDR Mini](/workspaces/Diplom/docs/word/imgs/image-23.png){ width=8.0cm }
...
<!-- 
### ADALM-Pluto (PlutoSDR)[9]

![Рис 4.4. ADALM-Pluto](/workspaces/Diplom/docs/word/imgs/image-24.png){ width=8.0cm }
...
### Raspberry Pi Compute Module 4[10]

![Рис 4.5. Raspberry Pi Compute Module 4](/workspaces/Diplom/docs/word/imgs/image-4.png){ width=8.0cm }
...
![Рис 4.6. NVIDIA Jetson Nano](/workspaces/Diplom/docs/word/imgs/image-13.png){ width=8.0cm }
...
Офіційна сторінка Jetson Nano[11]


### Radxa CM3[12]

![Рис 4.7. Radxa CM3](/workspaces/Diplom/docs/word/imgs/image-14.png){ width=8.0cm }
...
### Banana Pi BPI-CM4[13]

![Рис 4.8. Banana Pi BPI-CM4](/workspaces/Diplom/docs/word/imgs/image-15.png){ width=8.0cm }
...
![Рис 4.9. USB карта відеозахоплення LUX EasyCap](/workspaces/Diplom/docs/word/imgs/image.png){ width=8.0cm }
...
### Digitnow USB 2.0 Video Capture Card[14]
...
<!-- ### August VGB100 USB Video Capture Stick[15]

![Рис 4.10. August VGB100 USB Video Capture Stick](/workspaces/Diplom/docs/word/imgs/image-25.png){ width=8.0cm }
...
### GPS модуль NEO-6M v2[16]

![Рис 4.11. GPS модуль NEO-6M v2](/workspaces/Diplom/docs/word/imgs/image6.png){ width=8.0cm }
...
### SSD диск Transcend MTS420S 240GB M.2 2242 SATAIII 3D NAND TLC[17]

![Рис 4.12. SSD диск Transcend MTS420S](/workspaces/Diplom/docs/word/imgs/image-5.png){ width=8.0cm }
...
### Сенсорний дисплей IBM Lenovo Wacom 12.1in XGA LCD Touch Screen[18]

![Рис 4.13. IBM Lenovo Wacom 12.1in XGA LCD Touch Screen](/workspaces/Diplom/docs/word/imgs/image-2.png){ width=8.0cm }
...
### Waveshare 10.1" HDMI LCD with Capacitive Touch[19]

![Рис 4.14. Waveshare 10.1 HDMI LCD](/workspaces/Diplom/docs/word/imgs/image-19.png){ width=8.0cm }
...
### Official Raspberry Pi 7" Touchscreen Display[20]

![Рис 4.15. Raspberry Pi 7 Touchscreen](/workspaces/Diplom/docs/word/imgs/image-20.png){ width=8.0cm }
...
<!-- ### BOE 10.1" MIPI DSI IPS LCD Touch Screen[21]

![Рис 4.16. BOE MIPI 10.1 DSI](/workspaces/Diplom/docs/word/imgs/image-21.png){ width=8.0cm }
...
### Типи та різновиди[22]

У літієвих пристроїв багато видів із різними елементами у складі катода. У деяких модифікаціях в аноді може повністю або частково замінюватись графіт.
...
*  Літій-залізо-фосфатні (LiFePO4)[23]
...
<w:p>
  ...
  <w:r>
    <w:t>Табл 4.1. Загальні експлуатаційні характеристики Li-ion елементів живлення</w:t>
  </w:r>
</w:p>
```

<div style="text-align: center;">![](/workspaces/Diplom/docs/word/tables/Litium.png){ width=8.0cm }</div>

* Акумулятор літій-полімерний 10000 mAh, 3.7v, 1260110[24]

![Рис 4.16. li-ion 10 Ah, 3.7v, 1260110](/workspaces/Diplom/docs/word/imgs/image-31.png){ width=8.0cm }
...
### Compute Module 4 IO Board[25]

![Рис 4.17. Compute Module 4 IO Board](/workspaces/Diplom/docs/word/imgs/image-3.png){ width=8.0cm }
...
### Waveshare CM4 IO Base Board B[26]

![Рис 4.18. Waveshare CM4 IO Base Board B](/workspaces/Diplom/docs/word/imgs/image-16.png){ width=8.0cm }
...
### Seeed Studio reComputer CM4 IO Board[27]

![Рис 4.19. Seeed Studio reComputer CM4 IO Board](/workspaces/Diplom/docs/word/imgs/image-17.png){ width=8.0cm }
...
<!-- ### DFRobot Raspberry Pi CM4 IoT Router Carrier Board Mini[28]

![Рис 4.20. DFRobot CM4 IoT Router Carrier](/workspaces/Diplom/docs/word/imgs/image-18.png){ width=8.0cm }
