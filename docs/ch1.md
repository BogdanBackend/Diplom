...
На ринку представлено низку портативних SDR-пристроїв, які відрізняються функціональністю, діапазоном частот, типом інтерфейсів та можливостями програмного забезпечення. Нижче наведено детальний огляд основних моделей:

- **HackRF One Portapack H4 Mayhem**  
    Це універсальна портативна SDR-станція, яка поєднує в собі базовий модуль HackRF One, додатковий модуль PortaPack H4 та програмне забезпечення Mayhem. Пристрій оснащений сенсорним дисплеєм, навігаційними кнопками та енкодером для зручного керування. Підтримує роботу у широкому діапазоні частот (1 МГц – 6 ГГц), дозволяє приймати, аналізувати та передавати різноманітні радіосигнали. Завдяки відкритому програмному забезпеченню Mayhem, користувач отримує розширені можливості для аналізу, тестування бездротових мереж, моніторингу стільникових мереж, експлуатації радіочастот, а також для програмування та досліджень. Оновлений модуль H4 має покращений екран, розширені інтерфейси (GPIO), вдосконалену систему живлення та зручний перемикач для роботи з мікрофоном і навушниками.

- **LibreSDR PLUTO з Zynq 7020**  
    Аналог популярного модуля ADALM-PLUTO, виконаний у міцному металевому корпусі для кращого тепловідведення. Побудований на базі FPGA Zynq 7020, підтримує два приймальних і два передавальних канали, що дозволяє працювати у дуплексному режимі. Діапазон робочих частот — 70 МГц – 6 ГГц. Пристрій має широкий набір інтерфейсів: Ethernet (Gigabit), USB (OTG і Debug), MicroSD, MMCX для синхронізації, SMA для антен. Завдяки інтегрованому радіочастотному трансиверу AD9363 та підтримці відкритого ПЗ, LibreSDR підходить для складних задач аналізу, тестування та розробки у сфері радіозв'язку.

- **1.10D DSP SDR**  
    Це портативний приймач, який підтримує різні режими демодуляції (AM, SSB, NFM, WFM, CW) та має широкий частотний діапазон (10 кГц – 2 ГГц). Оснащений сенсорним IPS-екраном, потужним процесором stm32h743, подвійними антенними входами та вбудованим акумулятором великої ємності. Пристрій має розвинені функції обробки сигналу: змінна ширина фільтра, адаптивне та порогове шумозаглушення, AGC, еквалайзер. Підтримується підключення до ПК через USB для передачі IQ-даних та аудіо, що розширює можливості аналізу та запису сигналів.

- **Amator SDR 1 МГц – 6 ГГц**  
    Портативний радіотрансивер, який дозволяє як приймати, так і передавати сигнали у широкому діапазоні частот. Оснащений 3,2-дюймовим сенсорним екраном, навігаційними перемикачами, аудіороз'ємом 3,5 мм для підключення мікрофона та навушників. Пристрій підтримує функцію запису та відтворення сигналів (наприклад, з пультів дистанційного керування ISM-діапазону), має розвинений функціонал для роботи з різними типами радіосигналів, включаючи SSB, AM, NFM, WFM, а також спеціалізовані функції для аналізу, тестування та моніторингу.

- **Malahit DSP2 SDR**  
    Приймач другого покоління з сенсорним IPS-екраном, підтримкою широкого частотного діапазону (10 кГц – 2 ГГц), адаптивним шумозаглушенням, автоматичним регулюванням підсилення, еквалайзером та іншими сучасними функціями. Оснащений літій-іонним акумулятором великої ємності, має роз'єм SMA для підключення антен, підтримує різні типи модуляції (AM, SSB, DSB, CW, NFM, WFM), а також функції для роботи з активними антенами та режимом високого імпедансу.

### Порівняльний аналіз

Всі розглянуті пристрої мають спільні риси — портативність, гнучкість налаштувань, підтримку широкого частотного діапазону та можливість оновлення програмного забезпечення. Водночас, кожна модель має свої унікальні особливості:

- **HackRF One Portapack H4 Mayhem** — універсальність, розширене ПЗ, зручний інтерфейс керування.
- **LibreSDR PLUTO** — потужна апаратна база, підтримка дуплексного режиму, багатий набір інтерфейсів.
- **1.10D DSP SDR** — широкий набір режимів демодуляції, розвинені функції обробки сигналу, автономність.
- **Amator SDR** — можливість запису/відтворення сигналів, простота використання, широкий спектр застосування.
- **Malahit DSP2 SDR** — сучасний сенсорний інтерфейс, адаптивне шумозаглушення, підтримка різних типів антен.

Ці пристрої забезпечують гнучкість, портативність та широкий спектр застосування для вирішення завдань виявлення, аналізу та тестування радіосигналів у різних умовах — від польових досліджень до лабораторних експериментів і навчання.
...
Програмно-визначувана радіостанція [HackRF One](https://fd24.com.ua/ua/p1044872164-sdr-radiostantsiya-antennami.html?source=merchant_center&gad_source=1&gad_campaignid=16695681573&gbraid=0AAAAACqF10_-rY4lJZlaJmtpxI3HFCwSQ&gclid=CjwKCAjw56DBBhAkEiwAaFsG-tMrTVbThssU7Zpa5kQyvDk9m0I4ZMkaidrQvP96XgwxpQHuhkZQ7RoCglAQAvD_BwE)
з додатковим модулем PortaPack H4 та програмним забезпеченням Mayhem – універсальне портативне рішення для роботи, передачі і аналізу радіосигналів в широкому діапазоні частот. Цей пристрій створено на відкритому вихідному коді та володіє великим спектром застосування: моніторинг стільникових мереж, аналіз бездротових протоколів, програмування та експлуатація радіочастот, тестування безпеки бездротових мереж і багато іншого.
...
[LibreSDR](https://fd24.com.ua/ua/p2465955107-sdr-radiostantsiya-antennami.html)
є аналогом популярного SDR-модуля ADALM-PLUTO (або PlutoSDR), який зроблений у металевому корпусі для ефективнішого розсіювання тепла та міцності.
...
Malahit-DSP2 SDR[5], оригінальний приймач другого покоління, 10 кГц-380 МГц, 404 МГц-2 ГГц. Найновіша прошивка версії 2.40 абсолютно новий оригінальний приймач Malahit-DSP2.
...
![Table: Порівняння існуючих розробок](tables/SDR.png)

## Висновок по розділу 1

> **TODO: написати висновок**
...
Однак більшість систем  потребують значних фінансових та технічних ресурсів. Це відкриває перспективи для розробки компактних, економічно ефективних систем, орієнтованих на малі групи, що можуть виконувати завдання в автономному режимі з мінімальною інфраструктурою.
