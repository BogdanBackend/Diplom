...
Відстеження супутника:
За допомогою Orbitron введено координати та додано TLE-дані для NOAA-15/18/19. Програма показує точний час проходження супутника.
...
Обробка аудіофайлу:
За необхідності конвертація формату здійснюється у SDR#.

Декодування:
Завантажено файл у LRPTDecoder, запущено демодуляцію.
